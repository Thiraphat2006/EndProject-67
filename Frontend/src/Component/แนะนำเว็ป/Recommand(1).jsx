...
import BG from '../../../public/Image/BG/remove01.png'
    ...
    return (
        <>
            <div className="img-bg h-full  ">
                <img src={BG} alt="" className='fade-in object-contain h-auto w-[250px] bottom-0 md:bottom-[0px] md:top-[500px] md:w-[1500px] lg:top-[625px] xl:w-[1250px] xl:top-[0px]' />
